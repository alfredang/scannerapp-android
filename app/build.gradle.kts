...
// Release signing is configured via a gitignored keystore.properties at the project root.
...
android {
    namespace = "com.tertiaryinfotech.scannerapp"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.tertiaryinfotech.scannerapp"
        minSdk = 24
        targetSdk = 36
        versionCode = 2
        versionName = "1.0.1"
